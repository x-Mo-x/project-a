    ...
    227: function (e, t, r) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.addBasePath = function (e, t) {
          0;
          return a.normalizePathTrailingSlash(n.addPathPrefix(e, "/project-a"));
        });
      var n = r(9782),
        a = r(4969);
    ...
    8771: function (e, t, r) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.hasBasePath = function (e) {
          return n.pathHasPrefix(e, "/project-a");
        });
      var n = r(9880);
      ("function" === typeof t.default ||
        ("object" === typeof t.default && null !== t.default)) &&
                  ...
                  switch ((e.prev = e.next)) {
                    case 0:
                      return (
                        ...
                        (I = w.getURL()),
                        L.hasBasePath(I) && (I = M.removeBasePath(I)),
                        N.scriptLoader &&
                          ((o = r(2189)),
        ...
        return (
          (function (e, t) {
            ...
            return v.default.createElement(
              se,
              { callbacks: [e, f] },
              v.default.createElement(v.default.StrictMode, null, p)
            );
          }),
          l
        );
    ...
    5678: function (e, t, r) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.removeBasePath = function (e) {
          0;
          (e = e.slice("/project-a".length)).startsWith("/") ||
            (e = "/".concat(e));
          return e;
        });
      r(8771);
    ...
    4957: function (e, t, r) {
      ...
      function U(e, t, r) {
        var n = H(e, t, !0),
          ...
          l = u && u.startsWith(c);
        (o = F(o)), (u = u ? F(u) : u);
        var f = s ? o : M.addBasePath(o),
          d = r ? F(H(e, r)) : u || o;
        return { url: f, as: l ? d : M.addBasePath(d) };
      }
      function W(e, t) {
              ...
              (this.onPopState = function (e) {
                ...
                if (r) {
                  if (r.__NA) window.location.reload();
                    ...
                    (i.isSsr &&
                      a === M.addBasePath(i.asPath) &&
                      c === M.addBasePath(i.pathname)) ||
                      (i._bps && !i._bps(r)) ||
                      i.change(
                        "replaceState",
                        n,
            ...
            o(e, [
                            ...
                            switch ((n.prev = n.next)) {
                              ...
                              case 25:
                                if (
                                  ...
                                  (V = k.removeLocale(
                                    L.hasBasePath(a) ? C.removeBasePath(a) : a,
                                    y.locale
                                  )),
                                  (l._inFlightRoute = a),
                                  ($ = P !== y.locale),
                                  f || !l.onlyAHashChange(V) || $)
                                ) {
                                  n.next = 49;
                                  break;
                                }
                              ...
                              case 64:
                                return (
                                  l.urlIsNew(V) || $ || (t = "replaceState"),
                                  (ne = a),
                                  (J = J
                                    ? d.removeTrailingSlash(C.removeBasePath(J))
                                    : J),
                                  (n.next = 69),
                                  Q({ asPath: a, locale: y.locale, router: l })
                                );
                              case 69:
                                if (
                                  ((ae = n.sent),
                                  o.shallow && ae && (J = l.pathname),
                                  !m || "/_error" === J)
                                ) {
                                  n.next = 84;
                                  break;
                                }
                                (o._shouldResolveHref = !0), (n.next = 82);
                                break;
                              case 78:
                                ae || (ne = oe.asPath),
                                  oe.matchedPage &&
                                    oe.resolvedHref &&
                                    ((J = oe.resolvedHref),
                                    (X.pathname = M.addBasePath(J)),
                                    ae || (r = j.formatWithValidation(X))),
                                  (n.next = 84);
                                break;
                              case 82:
                                (X.pathname = W(J, ee)),
                              ...
                              case 107:
                                return (
                                  f || e.events.emit("routeChangeStart", a, Z),
                                  (n.prev = 108),
                                  (n.next = 111),
                                  l.getRouteInfo({
                                    route: ie,
                                ...
                                if (
                                  ("route" in (ve = n.sent) &&
                                    ...
                                    b.isDynamicRoute(J) &&
                                      ...
                                      (ye = me),
                                      L.hasBasePath(ye) &&
                                        (ye = C.removeBasePath(ye)),
                                      (ge = E.getRouteRegex(J)),
                                      (_e = S.getRouteMatcher(ge)(ye)) &&
                                        Object.assign(K, _e))),
                                  !("type" in ve))
                                ) {
                                  n.next = 120;
                              ...
                              case 120:
                                ...
                                if (
                                  ((o.locale = !1),
                                  !(je = we.pageProps.__N_REDIRECT).startsWith(
                                    "/"
                                  ) ||
                                ...
                                return (
                                  ((Re = x.parseRelativeUrl(je)).pathname = W(
                                    Re.pathname,
                                    ee
                                  )),
                                  (Oe = U(l, je, je)),
                                  (ke = Oe.url),
                                  (Ce = Oe.as),
                                  n.abrupt("return", l.change(t, ke, Ce, o))
                                );
                              case 132:
                                return (
                                  Y({ url: je, router: l }),
                              ...
                              case 150:
                                if (
                                  ...
                                  o._h &&
                                    ...
                                    !g &&
                                    !$ &&
                                    N.compareRouterStates(De, l.state))
                                ) {
                                  n.next = 169;
                                  break;
                                }
                              ...
                              case 162:
                                ...
                                throw (
                                  (f ||
                                    e.events.emit("routeChangeError", xe, V, Z),
                                  xe)
                                );
                              case 165:
                                0,
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return u(
                    n.mark(function e() {
                      var g, _, w, P, S, E, R, O, k, M, L, A, T, N, I, D;
                      return n.wrap(
                        function (e) {
                          for (;;)
                            switch ((e.prev = e.next)) {
                              case 0:
                                if (
                                  ((g = t),
                                  (e.prev = 1),
                                  (S = J({ route: g, router: m })),
                                  (E = m.components[g]),
                                  !s.shallow || !E || m.route !== g)
                                ) {
                                  e.next = 6;
                                  break;
                                }
                              ...
                              case 36:
                                return (
                                  (L = M.__N_RSC && M.__N_SSP),
                                  (A = M.__N_SSG || M.__N_SSP || M.__N_RSC),
                                  (e.next = 40),
                                  m._getData(
                                    u(
                                      n.mark(function e() {
                          ...
                          switch ((n.prev = n.next)) {
                            ...
                            case 14:
                              if (
                                ...
                                (v = m.__rewrites),
                                !(y = P.default(
                                  M.addBasePath(O.addLocale(t, a.locale), !0),
                                  l,
                                  v,
                                  i.query,
                                  function (e) {
                              ...
                              if (
                                ("rewrite" ===
                                  (null == (g = n.sent)
                                    ? void 0
                                    : g.effect.type) &&
                                  ((i.pathname = g.effect.resolvedHref),
                                  (u = g.effect.resolvedHref),
                                  (s = c({}, s, g.effect.parsedAs.query)),
                            ...
                            case 31:
                              return (
                                (_ = d.removeTrailingSlash(u)),
                                (n.next = 34),
                                Promise.all([
                                  a.pageLoader._isSsg(_).then(function (t) {
                                    return (
                                      !!t &&
                                      V({
                                        dataHref:
      ...
      function Q(e) {
        return Promise.resolve(e.router.pageLoader.getMiddleware()).then(
          function (t) {
            var r = R.parsePath(e.asPath).pathname,
              n = L.hasBasePath(r) ? C.removeBasePath(r) : r,
              a = null == t ? void 0 : t.location;
            return !!a && new RegExp(a).test(O.addLocale(n, e.locale));
          }
        );
      }
      function ee(e) {
                      ...
                      if (o.startsWith("/")) {
                        ...
                        return Promise.all([
                          ...
                          var n = i(t, 2),
                            ...
                            u =
                              (n[1].__rewrites,
                              O.addLocale(l.pathname, l.locale));
                          if (
                            b.isDynamicRoute(u) ||
                            (!a &&
                              o.includes(
      ...
      (K.events = g.default()), (t.default = K);
    },
    8249: function (e, t, r) {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 }),
